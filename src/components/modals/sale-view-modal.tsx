    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-xl font-semibold">Détails de la Vente #{sale.id}</h2>
          <button
            onClick={onClose}
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{sale.nom_client}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {format(new Date(sale.date_vente), "dd MMMM yyyy 'à' HH:mm", { locale: fr })}
                    </p>
                  </div>
                </div>
              </div>
                ...
                {sale.utilisateurs && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {sale.utilisateurs.prenom} {sale.utilisateurs.nom}
                      </p>
                      <p className="text-sm text-gray-500">{sale.utilisateurs.email}</p>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {parseFloat(sale.total.toString()).toFixed(2)} DH
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-medium">Produits vendus</h3>
                <Badge variant="secondary">{sale.lignes_vente.length}</Badge>
              </div>

              <div className="space-y-3">
                {sale.lignes_vente.map((line, index) => (
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-2xl font-bold text-blue-600">
                    {sale.lignes_vente.length}
                  </p>
                  <p className="text-sm text-gray-600">Article(s)</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-blue-600">
                    {sale.lignes_vente.reduce((sum, line) => sum + line.quantite, 0)}
                  </p>
